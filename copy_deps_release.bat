...
copy %PROJECT_ROOT%\third_party\CrashRpt\bin\CrashRpt1402.dll %PROJECT_RELEASE_PATH%
copy %PROJECT_ROOT%\third_party\CrashRpt\bin\CrashSender1402.exe %PROJECT_RELEASE_PATH%
